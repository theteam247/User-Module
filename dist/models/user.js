    ...
    static define(opts) {
        User.init(Object.assign({}, opts.attributes, { id: {
            ...
            passwordResetToken: {
                ...
                type: sequelize_1.DATE,
                allowNull: true
            } }), Object.assign({ sequelize: opts.sequelize }, opts.options, { validate: {
                emailOrPhone() {
                    if (!this.email && !this.phoneNumber) {
                        throw new Error("Require either email or phoneNumber");
                    }
                }
            }, paranoid: true, hooks: Object.assign({}, (opts.options || {}).hooks, { beforeCreate: (user) => __awaiter(this, void 0, void 0, function* () {
